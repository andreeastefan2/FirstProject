...
const randomEmail = faker.internet.email({firstName:randomName, provider: 'qa.com'});
...
// This is a test that expects to fail the request and return 400 Bad Request as per Postman 
